...
/*=========================================================================
    Projects Carousel Reverse
=========================================================================*/
    $('#projects-carousel-reverse').owlCarousel({
        loop: true,
        margin: 5,
        autoplay: true,
        smartSpeed: 500,
...
=========================================================================*/
    ...
    // One-page scrollspy: highlight nav based on visible section
    $(function(){
        var $navLinks = $('.header-section .nav a[data-scroll]');
        ...
        ['about','services','projects','team','contact'].forEach(function(id){
            var el = document.getElementById(id);
            if(el) observer.observe(el);
        });

        // Keep Home active near top of page
        $(window).on('scroll', function(){
            if ($(this).scrollTop() < 200) setActive('home');
        });

        // Also set active on click for instant feedback
        $(document).on('click', '.header-section .nav a[data-scroll]', function(){
